...
let totalTimeNeeded = brushTeeth + uploadPhotos + chooseClothes + shower + goJogging + finishHomework + fixLunch
...
let needToDo = brushTeeth + chooseClothes + shower + fixLunch + finishHomework
let dontNeedToDo = uploadPhotos + goJogging
